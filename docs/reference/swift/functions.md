...
```
<codapi-snippet engine="codapi" sandbox="swift" editor="basic", depends-on="loadData"></codapi-snippet>
...
```
<codapi-snippet engine="codapi" sandbox="swift" editor="basic" id="closedFunc"></codapi-snippet>
...
```
<codapi-snippet engine="codapi" sandbox="swift" editor="basic" depends-on="closedFunc"></codapi-snippet>
